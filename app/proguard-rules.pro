...
-keep class com.minnovel.weiweiyixiaohenqingcheng.widget.**{*;}
-keep class com.minnovel.weiweiyixiaohenqingcheng.bean.**{*;}
-keep class android.support.**{*;}
...
-keep public class com.minnovel.weiweiyixiaohenqingcheng.R$*{
