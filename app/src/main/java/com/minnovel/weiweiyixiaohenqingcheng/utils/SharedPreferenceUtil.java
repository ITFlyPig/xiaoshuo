...
public class SharedPreferenceUtil {
    ...
    public static void setStringDataIntoSP(String spName, String keyStr, String valueStr) {
    	SharedPreferences sp = MApplication.getInstance().getSharedPreferences(spName, MODE_PRIVATE);
...
//	    	SharedPreferences sp = MApplication.getApplication().getSharedPreferences(spName, MODE_PRIVATE);
