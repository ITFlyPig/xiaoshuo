package com.minnovel.weiweiyixiaohenqingcheng.widget.contentswitchview;
...
import com.minnovel.weiweiyixiaohenqingcheng.ReadBookControl;
import com.minnovel.weiweiyixiaohenqingcheng.R;
import com.minnovel.weiweiyixiaohenqingcheng.ReadBookControl;
import com.minnovel.weiweiyixiaohenqingcheng.widget.MTextView;
...
public class BookContentView extends FrameLayout {
    ...
    private void init() {
        ...
        tvContent = (com.minnovel.weiweiyixiaohenqingcheng.widget.MTextView) view.findViewById(R.id.tv_content);
